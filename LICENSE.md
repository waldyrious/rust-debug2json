...
Copyright (C) 2026 Waldir Pimenta <waldyrious@gmail.com>

## Preamble

This Simple Public License 2.0 (SimPL 2.0 for short)
is a plain language implementation of GPL 2.0.
The words are different, but the goal is the same
– to guarantee for all users the freedom to share and change software.
...
- If the software damages you in any way,
  you may only recover direct damages up to the amount you paid for it
  (that is zero if you did not pay anything).
